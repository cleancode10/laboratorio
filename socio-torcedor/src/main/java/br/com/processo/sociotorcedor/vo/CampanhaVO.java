...
public class CampanhaVO implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5669898985145568472L;
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CampanhaVO)) {
			return false;
		}
		CampanhaVO other = (CampanhaVO) obj;
		if (dtFim == null) {
			if (other.dtFim != null) {
				return false;
			}
	...
	public String toString() {
		return "CampanhaVO [id=" + id + ", nome=" + nome + ", idClube=" + idClube + ", dtInicio=" + dtInicio
				+ ", dtFim=" + dtFim + "]";
	}
